...
<head>
    ...
    <script>
        WebFont.load({
            google: {
                families: ['Calligraffitti', 'Roboto', 'Roboto Condensed']
            }
        });
    </script>
    ...
    <link rel="icon" type="image/png" href="<?php bloginfo('stylesheet_directory'); ?>/images/favicon/favicon-192x192.png" sizes="192x192">
    <link rel="icon" type="image/png" href="<?php bloginfo('stylesheet_directory'); ?>/images/favicon/favicon-160x160.png" sizes="160x160">
    ...
    <meta name="msapplication-TileImage" content="<?php bloginfo('stylesheet_directory'); ?>/images/favicon/mstile-144x144.png">
